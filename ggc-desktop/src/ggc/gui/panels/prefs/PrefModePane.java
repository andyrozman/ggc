...
public class PrefModePane extends AbstractPrefOptionsPanel implements HelpCapable
{
    ...
    private void init()
    {
        ...
        ATSwingUtils.getLabel(m_ic.getMessage("APPLICATION_MODE") + ": ", 
                              20, 30, 130, 25, 
                              p1, ATSwingUtils.FONT_NORMAL);
        
        String[] modes = { m_ic.getMessage("PEN_INJECTION_MODE"), 
                           m_ic.getMessage("PUMP_MODE")};
        
        cb_fields[SW_MODE] = ATSwingUtils.getComboBox(modes, 
                                           180, 30, 200, 25, 
                                           p1, ATSwingUtils.FONT_NORMAL);
        cb_fields[SW_MODE].setSelectedIndex(config_manager.getIntValue("SW_MODE")); 
        
        
        ATSwingUtils.getLabel(m_ic.getMessage("APPLICATION_MODE_DESC"), 
            20, 60, 440, 50, 
            p1, ATSwingUtils.FONT_NORMAL);
        ...
        ATSwingUtils.getLabel(m_ic.getMessage("BASAL_PRECISSION") + ": ", 
            20, 27, 130, 25, 
            p2, ATSwingUtils.FONT_NORMAL);

        cb_fields[PEN_BASAL_PRECISSION] = ATSwingUtils.getComboBox(pen_precission, 
            180, 25, 80, 25, 
            p2, ATSwingUtils.FONT_NORMAL);
        cb_fields[PEN_BASAL_PRECISSION].setSelectedItem(config_manager.getStringValue("PEN_BASAL_PRECISSION")); 
        
        ATSwingUtils.getLabel(m_ic.getMessage("BOLUS_PRECISSION") + ": ", 
            20, 57, 130, 25, 
            p2, ATSwingUtils.FONT_NORMAL);
        
        cb_fields[PEN_BOLUS_PRECISSION] = ATSwingUtils.getComboBox(pen_precission, 
            180, 55, 80, 25, 
            p2, ATSwingUtils.FONT_NORMAL);
        cb_fields[PEN_BOLUS_PRECISSION].setSelectedItem(config_manager.getStringValue("PEN_BOLUS_PRECISSION")); 

        
        ATSwingUtils.getLabel(m_ic.getMessage("MAX_BASAL") + ": ", 
            290, 27, 130, 25, 
            p2, ATSwingUtils.FONT_NORMAL);
        
        num_fields[PEN_MAX_BASAL] = ATSwingUtils.getNumericTextField(3, 1, config_manager.getFloatValue("PEN_MAX_BASAL"), 
                                         400, 25, 60, 25, p2);

        ATSwingUtils.getLabel(m_ic.getMessage("MAX_BOLUS") + ": ", 
            290, 57, 130, 25, 
            p2, ATSwingUtils.FONT_NORMAL);
        
        num_fields[PEN_MAX_BOLUS] = ATSwingUtils.getNumericTextField(3, 1, config_manager.getFloatValue("PUMP_MAX_BOLUS"), 
                                         400, 55, 60, 25, p2);
        ...
        ATSwingUtils.getLabel(m_ic.getMessage("BASAL_PRECISSION") + ": ", 
            20, 27, 130, 25, 
            p3, ATSwingUtils.FONT_NORMAL);

        cb_fields[PUMP_BASAL_PRECISSION] = ATSwingUtils.getComboBox(pump_precission, 
            180, 25, 80, 25, 
            p3, ATSwingUtils.FONT_NORMAL);
        ...
        cb_fields[PUMP_BOLUS_PRECISSION] = ATSwingUtils.getComboBox(pump_precission, 
            180, 55, 80, 25, 
            p3, ATSwingUtils.FONT_NORMAL);
        ...
        num_fields[PUMP_MAX_BASAL] = ATSwingUtils.getNumericTextField(3, 1, config_manager.getFloatValue("PUMP_MAX_BASAL"), 
                                         400, 25, 60, 25, p3);
        ...
        num_fields[PUMP_MAX_BOLUS] = ATSwingUtils.getNumericTextField(3, 1, config_manager.getFloatValue("PUMP_MAX_BOLUS"), 
                                         400, 55, 60, 25, p3);
        
        // pump tbr type selector
        ATSwingUtils.getLabel(m_ic.getMessage("TBR_TYPE_SELECTOR") + ": ", 
            20, 87, 200, 25, 
            p3, ATSwingUtils.FONT_NORMAL);
        
        
        String[] tbr_type = {
                      m_ic.getMessage("TBR_TYPE_BOTH"),
                      m_ic.getMessage("TBR_TYPE_UNIT"),
                      m_ic.getMessage("TBR_TYPE_PROC")
        };

        cb_fields[PUMP_TBR_TYPE] = ATSwingUtils.getComboBox(tbr_type, 
            200, 87, 120, 25, 
            p3, ATSwingUtils.FONT_NORMAL);
        ...
        ATSwingUtils.getLabel(m_ic.getMessage("TBR_TYPE_UNIT") + ": ", 
            20, 117, 200, 25, 
            p3, ATSwingUtils.FONT_NORMAL);
        

        // pump min unit
        ATSwingUtils.getLabel(m_ic.getMessage("TASK_MIN") + ": ", 
            110, 117, 200, 25, 
            p3, ATSwingUtils.FONT_NORMAL);
        
        
        num_fields[PUMP_UNIT_MIN] = ATSwingUtils.getNumericTextField(3, 1, config_manager.getFloatValue("PUMP_UNIT_MIN"), 
                                                     160, 117, 40, 25, p3);

        // pump max unit
        ATSwingUtils.getLabel(m_ic.getMessage("TASK_MAX") + ": ", 
            230, 117, 200, 25, 
            p3, ATSwingUtils.FONT_NORMAL);
        
        num_fields[PUMP_UNIT_MAX] = ATSwingUtils.getNumericTextField(3, 1, config_manager.getFloatValue("PUMP_UNIT_MAX"), 
            280, 117, 40, 25, p3);

        // pump step unit
        ATSwingUtils.getLabel(m_ic.getMessage("TASK_STEP") + ": ", 
            350, 117, 200, 25, 
            p3, ATSwingUtils.FONT_NORMAL);
        
        num_fields[PUMP_UNIT_STEP] = ATSwingUtils.getNumericTextField(3, 1, config_manager.getFloatValue("PUMP_UNIT_STEP"), 
            420, 117, 40, 25, p3);

        
        ATSwingUtils.getLabel(m_ic.getMessage("TBR_TYPE_PROC") + ": ", 
            20, 147, 200, 25, 
            p3, ATSwingUtils.FONT_NORMAL);
        ...
        // min proc
        num_fields[PUMP_PROC_MIN] = ATSwingUtils.getNumericTextField(3, 1, config_manager.getFloatValue("PUMP_PROC_MIN"), 
                                                     160, 147, 40, 25, p3);
        ...
        // max proc
        num_fields[PUMP_PROC_MAX] = ATSwingUtils.getNumericTextField(3, 1, config_manager.getFloatValue("PUMP_PROC_MAX"), 
            280, 147, 40, 25, p3);
        ...
        // step proc
        num_fields[PUMP_PROC_STEP] = ATSwingUtils.getNumericTextField(3, 1, config_manager.getFloatValue("PUMP_PROC_STEP"), 
            420, 147, 40, 25, p3);
...
/*
  ...
  */
    ...
    public void saveProps()
    {
        ...
        config_manager.setStringValue("PUMP_BOLUS_PRECISSION", (String)cb_fields[PUMP_BOLUS_PRECISSION].getSelectedItem());
