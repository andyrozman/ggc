...
public class StatisticsInfoPanel extends AbstractInfoPanel
{
    ...
    private void init()
    {
        ...
        PanelIns1.setBorder(BorderFactory.createTitledBorder(m_ic.getMessage("BOLUS_INSULIN_SHORT") + " "
                + m_ic.getMessage("STATISTICS") + ":"));
        ...
        PanelIns2.setBorder(BorderFactory.createTitledBorder(m_ic.getMessage("BASAL_INSULIN_SHORT") + " "
                + m_ic.getMessage("STATISTICS") + ":"));
