...
public class FoodPartMainSelectorDialog extends JDialog implements ActionListener, KeyListener
{
     ...
     * @param except
     */
    public FoodPartMainSelectorDialog(JDialog parent, DataAccess da, int type, String except)
    {
        super(parent, "", true);
     ...
     * @param except
     */
    public FoodPartMainSelectorDialog(JFrame parent, DataAccess da, int type, String except)
    {
        super(parent, "", true);
     ...
     * @param ndd
     */
    public FoodPartMainSelectorDialog(JFrame parent, DataAccess da, NutritionDataDisplay ndd)
    {
        super(parent, "", true);
     ...
     * @param ndd
     */
    public FoodPartMainSelectorDialog(JDialog parent, DataAccess da, NutritionDataDisplay ndd)
    {
        super(parent, "", true);
     ...
     * @param hwd
     */
    public FoodPartMainSelectorDialog(JDialog parent, DataAccess da, HomeWeightDataDisplay hwd)
    {
        super(parent, "", true);
     ...
     * @param hwd
     */
    public FoodPartMainSelectorDialog(JFrame parent, DataAccess da, HomeWeightDataDisplay hwd)
    {
        super(parent, "", true);
