...
public class MealSpecialSelectorDialog extends JDialog implements ActionListener, ItemListener, KeyListener
{
     ...
     * @param meal_id
     */
    public MealSpecialSelectorDialog(JDialog parent, DataAccess da, long meal_id)
    {
        super(parent, "", true);
     ...
     * @param meal_id
     */
    public MealSpecialSelectorDialog(JFrame parent, DataAccess da, long meal_id)
    {
        super(parent, "", true);
     ...
     * @param part
     */
    public MealSpecialSelectorDialog(JDialog parent, DataAccess da, DailyFoodEntry part)
    {
        super(parent, "", true);
     ...
     * @param part
     */
    public MealSpecialSelectorDialog(JFrame parent, DataAccess da, DailyFoodEntry part)
    {
        super(parent, "", true);
