...
public class MealSelectorDialog extends JDialog implements ActionListener, KeyListener
{
     ...
     * @param meal_id
     */
    public MealSelectorDialog(JDialog parent, DataAccess da, long meal_id)
    {
        super(parent, "", true);
     ...
     * @param meal_id
     */
    public MealSelectorDialog(JFrame parent, DataAccess da, long meal_id)
    {
        super(parent, "", true);
     ...
     * @param part
     */
    public MealSelectorDialog(JDialog parent, DataAccess da, MealPart part)
    {
        super(parent, "", true);
     ...
     * @param part
     */
    public MealSelectorDialog(JFrame parent, DataAccess da, MealPart part)
    {
        super(parent, "", true);
