...
public class FoodPartSelectorDialog extends SelectorAbstractDialog
{
     ...
     * @param except
     */
    public FoodPartSelectorDialog(JDialog parent, DataAccess da, int type, String except) 
    {
        super(parent, da.getNutriI18nControl(), type, except, true);
        this.showDialog();
    }
     ...
     * @param except
     */
    public FoodPartSelectorDialog(JFrame parent, DataAccess da, int type, String except) 
    {
        super(parent, da.getNutriI18nControl(), type, except, true);
        this.showDialog();
    }
