...
public class PanelMealSelector extends /* GGCTreePanel */JPanel implements ActionListener
{
    ...
    public void actionPerformed(ActionEvent e)
    {
        ...
        {
            MealSpecialSelectorDialog mssd = new MealSpecialSelectorDialog(m_dialog, m_da, 0L);
        ...
        else if (action.equals("edit_food"))
        {
            ...
            MealSpecialSelectorDialog mssd = new MealSpecialSelectorDialog(m_dialog, m_da, _dfed.getDailyFoodEntry());
