...
public class PanelNutritionFoodEdit extends GGCTreePanel implements ActionListener
{
    ...
    public void actionPerformed(ActionEvent e)
    {
        ...
        {
            NutritionGroupDialog ngd = new NutritionGroupDialog(m_dialog, m_da, this.m_dialog.m_tree_type);
        ...
        {
            FoodPartMainSelectorDialog fpmsd = new FoodPartMainSelectorDialog(m_dialog, m_da,
        ...
        else if (action.equals("edit_nutrition"))
        {
            ...
            FoodPartMainSelectorDialog fpmsd = new FoodPartMainSelectorDialog(m_dialog, m_da, _ndd);
        ...
        else if (action.equals("edit_home_weight"))
        {
            ...
            FoodPartMainSelectorDialog fpmsd = new FoodPartMainSelectorDialog(m_dialog, m_da, _hwd);
