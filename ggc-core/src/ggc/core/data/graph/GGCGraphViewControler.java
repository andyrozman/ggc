...
//        in_resize = true;
        ...
        draw_button = ATSwingUtils.getButton("    " + m_ic.getMessage("DRAW"), 180, 7, 120, 25, button_panel, ATSwingUtils.FONT_NORMAL_BOLD, "paint.png", "draw", this, m_da);
        close_button = ATSwingUtils.getButton("    " + m_ic.getMessage("CLOSE"), 315, 7, 120, 25, button_panel, ATSwingUtils.FONT_NORMAL_BOLD, "cancel.png", "close", this, m_da);
...
*/
    ...
    public void runDraw()
    {
        ...
        //System.out.println("runDraw: dataRange: " + this.date_panel.getDateRangeData().toString());
