...
import ggc.cgms.device.dexcom.receivers.DexcomDeviceProgressReport.ProgressType;
...
public class DexcomG4Api {
    ...
    public DexcomG4Api(CommPort serialPort, CommPortIdentifier commPortIdentifier,
    ...
    public DatabasePageRange readDatabasePageRange(ReceiverRecordType recordType) throws DexcomException {
        ...
        log.debug("First page: " + dpr.getFirstPage() + ", Last page: " + dpr.getLastPage());
    ...
    public List<DatabasePage> readDatabasePages(ReceiverRecordType recordType, int pageNumber, int numberOfPages)
        ...
        short[] data = this.writeCommandAndReadRawResponse(DexcomG4Commands.ReadDatabasePages, null, new Object[] {
            (long)recordType.getValue(), (long)pageNumber, (long)numberOfPages });
    ...
    public int readDisplayTimeOffset() throws DexcomException {
        return (Integer)this.writeCommandAndReadParsedResponse(DexcomG4Commands.ReadDisplayTimeOffset);
    }
    ...
    public short[] readSpecifiedBytes(int nrBytes) throws Exception {
        ...
        // this.serialDevice.getInputStream().available());
        // this.serialDevice.getInputStream().read(retData);
        // }
        // catch (IOException e)
        // {
        ...
        InputStream is = this.serialDevice.getInputStream();
