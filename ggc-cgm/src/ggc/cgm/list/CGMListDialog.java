...
public class CGMListDialog extends JDialog implements TreeSelectionListener, ActionListener
{
    ...
    private DataAccessCGM m_da = null;
...
//    private static boolean useSystemLookAndFeel = false;
    ...
    public CGMListAbstractPanel  panels[] = null;
// x   private int selectedPanel = 0;

//    addMouseListener(this);
//    add(pop);
    
    CGMListRoot m_root = new CGMListRoot();
    
    
    public CGMListDialog(DataAccessCGM da) 
    {
    ...
    {
	    tree.setModel(new CGMListModel(this.m_root));
    }
    
    
    public void createPanels()
    {
    	panels = new CGMListAbstractPanel[2];

        panels[0] = new CGMListMainPanel(this);
        panels[1] = new CGMListCompanyPanel(this);
...
//x        selectedPanel = num;
    ...
    public void valueChanged(TreeSelectionEvent e) 
    {
    	...
    	if (this.selected_last_path instanceof CGMListRoot)
    	{
    		makePanelVisible(CGMListDialog.PANEL_MAIN);
    	}
    	else if (this.selected_last_path instanceof String)
    	{
    	    makePanelVisible(CGMListDialog.PANEL_METER_COMPANY);
    	    this.panels[CGMListDialog.PANEL_METER_COMPANY].setData(this.selected_last_path);
    	}
