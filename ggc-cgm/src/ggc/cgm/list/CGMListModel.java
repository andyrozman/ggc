...
public class CGMListModel implements TreeModel 
{
...
//x    private boolean isRoot = false;
    ...
    private CGMListRoot rootObj = null;


    public CGMListModel(CGMListRoot rt) 
    {
        //x isRoot = true;
        rootObj = rt;
    }
     ...
     */
    protected void fireTreeStructureChanged(CGMListRoot oldRoot) 
    {
    ...
    public Object getChild(Object parent, int index) 
    {
        ...
        if (parent instanceof CGMListRoot)
        {
