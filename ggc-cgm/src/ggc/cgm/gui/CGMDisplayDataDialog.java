...
public class CGMDisplayDataDialog extends JDialog implements ActionListener, OutputWriter
{
    ...
    private CGMValuesTableModel model = null;
    private CGMValuesTable table = null;
...
*/
    ...
    protected void init()
    {
        ...
        Font normal_b = m_da.getFont(DataAccessCGM.FONT_NORMAL_BOLD);
        ...
        this.table = new CGMValuesTable(model);
    ...
    public JPanel createTablePanel(CGMValuesTable table)
    {
        ...
        filter_combo.setSelectedIndex(CGMDisplayDataDialog.FILTER_NEW_CHANGED);
    ...
    public void actionPerformed(ActionEvent e)
    {
        ...
        else if (action.equals("export_data"))
        {
            ...
            CGMExportDialog med = new CGMExportDialog(this, ht, this.server);
    ...
    public static void main(String[] args)
    {
        ...
        DataAccessCGM.getInstance().addComponent(f);
