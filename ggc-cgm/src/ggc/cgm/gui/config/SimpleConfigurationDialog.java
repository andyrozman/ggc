...
//	prefPane = new JPanel(new BorderLayout());
        ...
        button.setFont(m_da.getFont(DataAccessCGM.FONT_NORMAL));
...
*/
    ...
    {
        this.config = new CGMConfiguration(true);
...
//            this.dispose();
        ...
        {
            CGMDeviceSelectorDialog mdsd = new CGMDeviceSelectorDialog(this, m_da);
            
            if (mdsd.wasAction())
            {
            
                CGMInterface mi = (CGMInterface)mdsd.getSelectedObject();
            ...
            sb.append("METER_X_COMPANY=" + mi.getCGMCompany().getName() + "\n");
    ...
    public static void main(String[] args)
    {
        ...
        DataAccessCGM da = DataAccessCGM.createInstance(fr);
        da.setMainParent(fr);
