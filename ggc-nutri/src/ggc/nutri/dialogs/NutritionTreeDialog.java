...
import ggc.nutri.panels.GGCTreePanel;
import ggc.nutri.panels.PanelNutritionFood;
import ggc.nutri.panels.PanelNutritionFoodEdit;
import ggc.nutri.panels.PanelNutritionFoodGroup;
import ggc.nutri.panels.PanelNutritionFoodGroupEdit;
import ggc.nutri.panels.PanelNutritionMain;
import ggc.nutri.panels.PanelNutritionMeal;
import ggc.nutri.panels.PanelNutritionMealEdit;
...
public class NutritionTreeDialog extends JDialog implements TreeSelectionListener, MouseListener, ActionListener
{
     ...
     * @param type
     */
    public NutritionTreeDialog(JDialog parent, ATDataAccessAbstract da, int type)
    {
     ...
     * @param type
     */
    public NutritionTreeDialog(JFrame parent, ATDataAccessAbstract da, int type)
    {
        this(parent, da, type, false);
    }
     ...
     * @param selector
     */
    public NutritionTreeDialog(JFrame parent, ATDataAccessAbstract da, int type, boolean selector)
    {
        super(parent, "", true);
     ...
     * @param selector
     */
    public NutritionTreeDialog(JDialog parent, ATDataAccessAbstract da, int type, boolean selector)
    {
        super(parent, "", true);
    ...
    {
        tree.setModel(new NutritionTreeModel(m_da.getDbCache().tree_roots.get("" + this.m_tree_type)));
    }
