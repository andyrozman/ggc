 ...
 * 
 *  Filename:     HomeWeightComparator  
 *  Description:  Home Weights Comparator
 * 
...
public class HomeWeightComparator implements Comparator<HomeWeightDataDisplay>
{
    ...
    /**
     * compare (HomeWeightDataDisplay, HomeWeightDataDisplay)
     * 
     ...
     */
    public int compare(HomeWeightDataDisplay mnd1, HomeWeightDataDisplay mnd2)
    {
