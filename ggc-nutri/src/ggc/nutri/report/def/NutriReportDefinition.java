 ...
 */
@Deprecated
public class NutriReportDefinition implements PluginReportDefinition
{

    DataAccessNutri dataAccessNutri; // = DataAccessPump.getInstance();
    I18nControlAbstract i18nControl; // =
                                     // dataAccessPump.getI18nControlInstance();

    DevicePlugInServer pluginServer;

    public enum NutriReportType
    {
        Simple(1), //
        Extended(2), //
        Profiles(3), //
    ...
    public NutriReportDefinition(DataAccessNutri dataAccessNutri)
    {
        this.dataAccessNutri = dataAccessNutri;
        this.i18nControl = dataAccessNutri.getI18nControlInstance();
    }
    ...
    public void startPlugInPrintMenusAction(String actionCommand)
    {
        ...
        // dataAccessPump, this, pumpReportType.type);
        // }
