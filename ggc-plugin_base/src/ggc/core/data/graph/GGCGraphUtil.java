...
public class GGCGraphUtil extends GraphUtil
{
    ...
    int BGUnit = DataAccessPlugInBase.BG_MGDL;
    JFreeChart chart;
    ...
    I18nControlAbstract translator;
    String unitLabel = "mg/dl";
    
    DataAccessPlugInBase m_da_local;
    ...
    {
        translator = m_da.getI18nControlInstance();
        //System.out.println("GGCGraphUtil");
        
        //m_da_local = DataAccessPlugInBase.getInstance();
        
        //settings = m_da_local.getSettings(); //DataAccess.getSettings();
        
        //colorScheme = settings.getSelectedColorScheme();
        BGUnit = ((DataAccessPlugInBase)m_da).getBGMeasurmentType();

        switch (BGUnit)
        {
            case DataAccessPlugInBase.BG_MMOL:
                maxBG = 11.1f;
                minBG = 2.775f;
                unitLabel = "mmol/l";
                break;

            case DataAccessPlugInBase.BG_MGDL:
            default:
                maxBG = 200;
                minBG = 50;
                unitLabel = "mg/dl";
