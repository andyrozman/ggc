...
public class MinimedCommandHistoryCGMS extends MinimedCommandHistoryData
{
    ...
    void setupCommandParameters(int i)
    {
         ...
         * historyPage.command_parameters[0] =
         * utils.getHexUtils().getLowNibble(i >> 24);
         * historyPage.command_parameters[1] = MedicalDevice.Util.getLowByte(i
         * >> 16);
         * historyPage.command_parameters[2] = MedicalDevice.Util.getLowByte(i
         * >> 8);
    ...
    void executeSumCommand() throws PlugInBaseException
    {
        /*
