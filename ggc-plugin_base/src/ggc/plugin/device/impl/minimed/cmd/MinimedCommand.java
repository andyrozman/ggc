...
public class MinimedCommand implements Serializable
{
     ...
     */
    /*
     * public MinimedCommand(int command_code_, String desc, int
     * cmd_parameter_count, int[] params)
     * {
    ...
    /*
     * public MinimedCommand(int command_code_, String desc, int
     * cmd_parameter_count, int[] params, int max_retries_)
     * {
     * this(command_code_, desc, cmd_parameter_count, params, max_retries_,
     * 2000);
     * }
     * public MinimedCommand(int command_code_, String desc, int
     * cmd_parameter_count, int[] params, int allowed_retries_, int
     * max_allowed_time_)
     * {
     * this(command_code_, desc, params, allowed_retries_, max_allowed_time_,
     * 0);
     * }
     */
     ...
     */
    /*
     * public MinimedCommand(int command_code_, String desc, int[] params, int
     * allowed_retries_, int max_allowed_time_, int type_of_reply_)
     * {
    ...
    public MinimedCommand(int code, String desc, int bytes_per_rec, int max_recs, int addy, int addy_len, int cmd_type)
    {
        this.command_description = desc;
    ...
    public String getFullCommandDescription()
    {
        if (this.sub_description == null)
            return " CMD [id=" + this.command_code + ",hex="
                    + MinimedDeviceUtil.getInstance().getHexUtils().getHex(command_code) + ",description="
                    + MinimedDeviceUtil.getInstance().getI18nControl().getMessage(this.command_description) + "] ";
        else
            return " CMD [id=" + this.command_code + ",hex="
                    + MinimedDeviceUtil.getInstance().getHexUtils().getHex(command_code) + ",description="
                    + MinimedDeviceUtil.getInstance().getI18nControl().getMessage(this.command_description) + "-"
