...
public class MinimedDeviceUtil
{
    ...
    public int[] createCommandByte(MinimedCommand command)
    {
         ...
         * ai = hex_utils.concatIntArrays(ai2,
         * m_deviceCommand.m_commandParameters);
        ...
        /*
         * int i = 0;
         * //Contract.pre(m_deviceCommand.m_cmdLength > 0,
         * "m_cmdLength is < 1.");
         * int ai[] = new int[7];
         * ai[i++] = 167;
    ...
    private static final String NAK_DESCRIPTIONS_TABLE[] = { "UNKNOWN NAK DESCRIPTION", "REQUEST PAUSE FOR 3 SECONDS",
                                                            "REQUEST PAUSE UNTIL ACK RECEIVED", "CRC ERROR",
                                                            "REFUSE PROGRAM UPLOAD", "TIMEOUT ERROR",
                                                            "COUNTER SEQUENCE ERROR", "PUMP IN ERROR STATE",
                                                            "INCONSISTENT COMMAND REQUEST", "DATA OUT OF RANGE",
                                                            "DATA CONSISTENCY", "ATTEMPT TO ACTIVATE UNUSED PROFILES",
                                                            "PUMP DELIVERING BOLUS",
                                                            "REQUESTED HISTORY BLOCK HAS NO DATA", "HARDWARE FAILURE" };
