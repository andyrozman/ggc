...
public class DeviceConfiguration
{
    ...
    public void writeConfigData()
    {
        ...
        sb.append("#\n# " + ic.getMessage("DEVICE_NAME_BIG") + " Tool (v" + m_da.getPlugInVersion()
                + ") Configurator\n");
        ...
        try
        {
            BufferedWriter bw = new BufferedWriter(new OutputStreamWriter(new FileOutputStream(new File(
                    this.dcd.getDevicesConfigurationFile())), "UTF8"));
    ...
    public void saveConfig()
    {
        try
        {
            ...
            BufferedWriter bw = new BufferedWriter(new OutputStreamWriter(new FileOutputStream(this.config_file),
                    "UTF8"));
