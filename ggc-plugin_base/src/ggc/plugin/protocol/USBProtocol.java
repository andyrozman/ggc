...
public abstract class USBProtocol extends DeviceAbstract
{
    ...
    // * @param da
    // */
    // public USBProtocol(String comm_parameters, OutputWriter writer,
    ...
    // USBProtocol.usb_machine.findUsbDevice(this.supported_devices);
    //
    // if (this.selected_device == null)
    // {
    ...
    // if (res < 0)
    // {
    // log.warn("Claiming failed: Error code: " + res + " (" +
    // this.usb.usb_strerror() + ")");
    // }
    //
    // }
    //
    ...
    // if (res < 0)
    // {
    // log.warn("Release failed: Error code: " + res + " (" +
    // this.usb.usb_strerror() + ")");
    // }
    //
    // }
    ...
    // else
    // {
    // int ret = this.usb.usb_bulk_read(this.selected_device.getDeviceHandle(),
    // USB_EP, b, b.length, USB_TIMEOUT);
    //
    // if (ret <= 0)
    // {
    ...
    // {
    // int res = this.usb.usb_bulk_write(this.handle, USB_EP, b, b.length,
    // this.USB_TIMEOUT);
    //
    // if (res <= 0)
    // {
    ...
    // {
    // return LibUsb4jUtil.getInstance().getStringFromDevice(handle,
    // index_code);
    // }
    //
    // public boolean usbBulkWrite(int ep, byte[] data)
    // {
    // return this.usb.usb_bulk_write(this.handle, ep, data, data.length,
    // this.USB_TIMEOUT) > 0;
    // }
    //
    // /*
