...
public class PumpTempValues extends DeviceTempValues
{
    ...
    public PumpTempValues(int _object_type, int _base_type, int _sub_type, Boolean isNumericValue)
    {
        this(_object_type, _base_type, _sub_type, null, isNumericValue);
    }

    public PumpTempValues(int _object_type, CodeEnumWithTranslation _base_type, int _sub_type, Boolean isNumericValue)
    {
        this(_object_type, _base_type.getCode(), _sub_type, null, isNumericValue);
    }

    public PumpTempValues(int _object_type, CodeEnumWithTranslation _base_type, CodeEnumWithTranslation _sub_type,
            Boolean isNumericValue)
    {
        this(_object_type, _base_type.getCode(), _sub_type.getCode(), null, isNumericValue);
    }

    public PumpTempValues(int _object_type, int _base_type, Boolean isNumericValue)
    {
        this(_object_type, _base_type, 0, null, isNumericValue);
    }

    public PumpTempValues(int _object_type, CodeEnumWithTranslation _base_type, Boolean isNumericValue)
    {
