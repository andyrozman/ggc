...
// This should be used for all writing of data, not like till now new instances of DeviceValuesWriter for each
// reading. If device has special values which can be used instead of this, we can using intermediary mapping
// map created.
...
//        addConfiguration("Event_BolusWizard", new PumpTempValues(PumpTempValues.OBJECT_BASE, //
//                PumpBaseType.Event, PumpEvents.BolusWizard, false));
//        addConfiguration("Event_BolusWizard", new PumpTempValues(PumpTempValues.OBJECT_BASE, //
//                PumpBaseType.Event, PumpEvents.BolusWizard, false));
