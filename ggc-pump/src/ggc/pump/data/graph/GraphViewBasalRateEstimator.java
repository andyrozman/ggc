...
import ggc.pump.gui.bre.BasalRateEstimatorData;
import ggc.pump.gui.bre.BasalRateEstimatorDataCollection;
...
//    private TimeSeriesCollection BGDataset = new TimeSeriesCollection();
    ...
    BasalRateEstimatorDataCollection data_coll;
...
//        XYSeries ins2Series = new XYSeries(da_local.getSettings().getIns2Name(), true, true); //, Hour.class);
        ...
        ArrayList<BasalRateEstimatorData> lst = this.data_coll.getDataByType(BasalRateEstimatorData.DATA_TYPE_BG);  
        ...
        for (int i = 0; i < lst.size(); i++)
        {
            ...
            BasalRateEstimatorData row = lst.get(i); 
