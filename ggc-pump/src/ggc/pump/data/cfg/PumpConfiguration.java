...
public class PumpConfiguration
{
    ...
    String config_text = "";
    File config_file = new File("../data/tools/PumpConfiguration.properties");
    
    PumpConfigEntry default_meter = null;
    
    public PumpConfiguration(boolean edit)
    {
        if (edit)
        {
            loadConfig();
    ...
    public PumpConfigEntry getDefaultMeter()
    {
    ...
    private String getEmptyConfig()
    {
        ...
        sb.append("#\n");
        sb.append("SELECTED_PUMP=1\n");
        sb.append("\n");
        sb.append("\n");
        sb.append("\n");
        sb.append("#\n");
        sb.append("#  Pump Device #1\n");
        sb.append("#\n");
        sb.append("PUMP_1_NAME=My meter\n");
        sb.append("PUMP_1_DEVICE=My meter\n");
        sb.append("PUMP_1_CONNECTION_PARAMETER=COM9\n");
        sb.append("\n");
