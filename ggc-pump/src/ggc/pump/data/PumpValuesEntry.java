...
//x    DayValueH m_dv = null;
 ...
 //x   GGCProperties props = m_da.getSettings();
    ...
    public PumpValuesEntry(long datetime, int bg, int ins1, int ins2, float ch, String extended, String comment)
    {
    ...
    public PumpValuesEntrylong datetime, int bg, int ins1, int ins2, float ch, String activity, String urine, String comment)
    {
        this.datetime = datetime;
        this.bg = bg; 
        this.ins1 = ins1;
...
/*
    public PumpValuesEntry(long datetime, String BG, String Ins1, String Ins2, String BU, String Act, String urine, String Comment, ArrayList<String> lst_meals)
    {
        //X
    	this.datetime = datetime;
