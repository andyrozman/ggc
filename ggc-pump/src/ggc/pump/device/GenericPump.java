...
public class GenericPump implements PumpInterface 
{
...
*/
    ...
    protected void readData(String input)
    {
    	...
    	PumpValuesEntry dv = new PumpValuesEntry();
    	dv.setDateTime(new ATechDate(Long.parseLong(time)));
    
    	if (unit.startsWith("mg/dL"))
    	{
    	    //x dv.setBG(PumpValuesEntry.BG_MGDL, value);
    	}
    	else
    	{
    	    //x dv.setBG(DailyValuesRow.BG_MMOLL, value);
    	}
