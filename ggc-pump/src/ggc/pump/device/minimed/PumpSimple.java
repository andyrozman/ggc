  ...
  */          
    ...
    public static void main(String[] args)
    {
        ...
        */
        ...
        int i = hex.makeInt(Integer.valueOf("01", 16).intValue(), Integer.valueOf("01", 16).intValue()); //, Integer.valueOf("00", 16).intValue());
