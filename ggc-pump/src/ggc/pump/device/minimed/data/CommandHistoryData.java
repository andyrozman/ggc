...
public class CommandHistoryData extends Command
{
        ...
        throws BadDeviceCommException
    {
        ...
        if(i <= j)
        {
            ...
            {
                MedicalDevice.logInfoLow(this, "execute: (" + m_description + ") reading page " + k + " (reading up to page " + j + ")");
                flag = readPage(k);
            }
        ...
        } else
        {
            ...
            {
                MedicalDevice.logInfoLow(this, "execute: (" + m_description + ") reading page " + l + " (reading down to page " + j + ")");
                flag = readPage(l);
            }

        }
        MedicalDevice.logInfoLow(this, "execute: " + m_description + " returned " + m_rawData.length + " bytes");
    }
        ...
        throws SerialIOHaltedException, BadDeviceCommException
    {
        ...
        do
            ...
            catch(BadDeviceCommException baddevicecommexception)
            {
                ...
                if(++j <= m_maxRetries)
                {
                    MedicalDevice.logWarning(this, "readPage: re-reading history data page " + i + " (attempts = " + (j + 1) + ")");
                    try
                    {
        ...
        try
        {
         // Write to disk with FileOutputStream
            FileOutputStream f_out = new 
                FileOutputStream("mm_history_page_" + page + ".data");
