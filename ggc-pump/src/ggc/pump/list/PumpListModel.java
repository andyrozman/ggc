...
public class PumpListModel implements TreeModel 
{
...
//x    private boolean isRoot = false;
    ...
    private PumpListRoot rootObj = null;


    public PumpListModel(PumpListRoot rt) 
    {
        //x isRoot = true;
        rootObj = rt;
    }
     ...
     */
    protected void fireTreeStructureChanged(PumpListRoot oldRoot) 
    {
    ...
    public Object getChild(Object parent, int index) 
    {
        ...
        if (parent instanceof PumpListRoot)
        {
