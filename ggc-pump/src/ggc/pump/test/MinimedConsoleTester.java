...
//        DataAccess da = DataAccess.createInstance(null, new LanguageManager(new GGCLanguageManagerRunner()));
//        da.loadSpecialParameters();
        /*
        GGCDb db = new GGCDb(da);
        db.initDb();
...
//        msp.readData();
        ...
        /*
        //Minimed554_Veo mm = new Minimed554_Veo(sb.toString(), new ConsoleOutputWriter());
        Minimed512 mm = new Minimed512(dap, sb.toString(), new ConsoleOutputWriter());
        ...
        */
        ...
        //Minimed554_Veo mm = new Minimed554_Veo(dap, sb.toString(), new ConsoleOutputWriter());
        //mm.readDeviceDataFull();
