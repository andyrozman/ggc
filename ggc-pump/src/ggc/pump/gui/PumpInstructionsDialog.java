...
*/
    ...
    public PumpInstructionsDialog(DbDataReaderAbstract reader, PumpPlugInServer server)
    {
        super();
        loadConfiguration();
    ...
    public String getMeterInterfaceParameter(int param)
    {
        switch(param)
        {
            case PumpInstructionsDialog.METER_INTERFACE_PARAM_CONNECTION_TYPE:
            {
                if (this.meter_interface==null)
                {
            ...
            case PumpInstructionsDialog.METER_INTERFACE_PARAM_STATUS:
            {
                if (this.meter_interface==null)
                {
...
*/
        ...
        Font bold = m_da.getFont(DataAccessPump.FONT_NORMAL);
