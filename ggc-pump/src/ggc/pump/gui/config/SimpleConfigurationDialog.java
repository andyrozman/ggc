...
//	prefPane = new JPanel(new BorderLayout());
        ...
        button.setFont(m_da.getFont(DataAccessPump.FONT_NORMAL));
...
*/
    ...
    {
        this.config = new PumpConfiguration(true);
...
//            this.dispose();
    ...
    public static void main(String[] args)
    {
        ...
        DataAccessPump da = DataAccessPump.createInstance(fr);
        da.setMainParent(fr);
