...
public class SimpleConfigurationHelp extends JDialog implements ActionListener 
{
    ...
    private static final long serialVersionUID = -7736163052250034544L;
    private I18nControl m_ic = I18nControl.getInstance();        
    private DataAccessPump m_da; // = DataAccessMeter.getInstance();
...
//	prefPane = new JPanel(new BorderLayout());
        ...
        //label.setHorizontalAlignment(JLabel.CENTER);
        label.setFont(m_da.getFont(DataAccessPump.FONT_NORMAL));
        prefPane.add(label);
        ...
        cancelButton.setFont(m_da.getFont(DataAccessPump.FONT_NORMAL));
