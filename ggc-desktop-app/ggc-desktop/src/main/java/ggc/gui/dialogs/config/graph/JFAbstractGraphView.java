...
/**
 * This one should be removed, together with DailyGraphView.
 */
public abstract class JFAbstractGraphView extends JPanel
{
    ...
    GGCProperties settings = dataAccess.getSettings();
    ...
    I18nControlAbstract translator = dataAccess.getI18nControlInstance();
    ...
    void applyMarkers(XYPlot plot)
    {
        ...
        switch (glucoseUnitType)
        {
            case mmol_L:
                lowBGMarker = new IntervalMarker(0, configurationManagerWrapper.getBG1TargetLow(),
                        dataAccess.getColor(colorScheme.getColor_bg_low()));
                targetBGMarker = new IntervalMarker(configurationManagerWrapper.getBG2TargetLow(),
                        ...
                        dataAccess.getColor(colorScheme.getColor_bg_target()));
                break;
            case mg_dL:
            default:
                lowBGMarker = new IntervalMarker(0, configurationManagerWrapper.getBG1TargetLow(),
        ...
        plot.setBackgroundPaint(dataAccess.getColor(colorScheme.getColor_bg_high()));
    }
}
