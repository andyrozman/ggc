...
public class GeneralInfoPanelL extends AbstractInfoPanel
{
    ...
    private void init()
    {
        ...
        add(new JLabel(i18nControl.getMessage("YOUR_NAME") + ":"));
        add(lblName);
        add(new JLabel(i18nControl.getMessage("BOLUS_INSULIN") + ":"));
        add(lblIns1);
        add(new JLabel(i18nControl.getMessage("BASAL_INSULIN") + ":"));
        add(lblIns2);
        add(new JLabel(i18nControl.getMessage("BG_UNIT") + ":"));
        add(lblUnit);
        add(new JLabel(i18nControl.getMessage("MODE") + ":"));
        add(lblMode);
    ...
    public void doRefresh()
    {
        ...
        System.out.println("Do Refresh: " + this.getClass().getSimpleName());
        ...
        // if (this.dataAccess.isDatabaseInitialized())
        {
            ...
            lblMode.setText(configurationManagerWrapper.getSoftwareModeType().getTranslation());
        }
    }
