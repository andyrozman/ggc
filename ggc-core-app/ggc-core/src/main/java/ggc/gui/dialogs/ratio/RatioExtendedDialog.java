...
public class RatioExtendedDialog extends JDialog implements ActionListener, HelpCapable, FocusListener, KeyListener
{
    ...
    private void init()
    {
        ...
        JPanel p1 = ATSwingUtils.getPanel(30, 70, 300, 150, null, new TitledBorder("Base Ratio's (for reference only)"),
            panel);

        ATSwingUtils.getLabel(m_ic.getMessage("INSULIN_CARB_RATIO"), 20, 30, 150, 25, p1,
            ATSwingUtils.FONT_NORMAL_BOLD);
        dtf_ch_ins = ATSwingUtils.getNumericTextField(2, new Float(0.0f), 170, 30, 60, 25, p1);
        ...
        ATSwingUtils.getLabel(m_ic.getMessage("SENSITIVITY_FACTOR_LONG"), 20, 60, 150, 45, p1,
            ATSwingUtils.FONT_NORMAL_BOLD);
        dtf_ins_bg = ATSwingUtils.getNumericTextField(2, new Float(0.0f), 170, 70, 60, 25, p1);
        ...
        dtf_bg_ch = ATSwingUtils.getNumericTextField(2, new Float(0.0f), 170, 110, 60, 25, p1);
        ...
        ATSwingUtils.getButton("", 20, 20, 30, 30, p2, ATSwingUtils.FONT_NORMAL, "table_add.png", "add_row", this,
            m_da);

        ATSwingUtils.getButton("", 55, 20, 30, 30, p2, ATSwingUtils.FONT_NORMAL, "table_edit.png", "edit_row", this,
            m_da);

        ATSwingUtils.getButton("", 90, 20, 30, 30, p2, ATSwingUtils.FONT_NORMAL, "table_delete.png", "delete_row", this,
            m_da);
