...
public class RatioEntryDialog extends JDialog implements HelpCapable, ChangeListener, ActionListener
{
    ...
    private void initGUI()
    {
        ...
        // setTitle(i18nControl.getMessage("RATIO_ENTRY"));
        // label_title.setText(i18nControl.getMessage("RATIO_ENTRY"));
        ...
        // ATSwingUtils.getLabel(i18nControl.getMessage("TIME_TILL"), 40, 115, 150, 25,
        ...
        ATSwingUtils.getLabel(m_ic.getMessage("PROCENT_OF_BASE") + ":", 40, 135, 150, 25, panel,
        ...
        ATSwingUtils.getButton("  " + m_ic.getMessage("OK"), 25, 320, 105, 25, panel, ATSwingUtils.FONT_NORMAL,
            "ok.png", "ok", this, m_da);
    ...
    public void actionPerformed(ActionEvent e)
    {
        ...
        else if (action.equals("time_from"))
        {
            if (tc_from.getTime() > tc_to.getTime())
            {
                ...
                // System.out.println("RatioEntryDialog::unknown command: Time From"+
                // action);
            }
        }
        else if (action.equals("time_to"))
        {
            if (tc_to.getTime() < tc_from.getTime())
            {
                ...
                // System.out.println("RatioEntryDialog::unknown command: Time To "
                // + action);
            }
        }
        else
