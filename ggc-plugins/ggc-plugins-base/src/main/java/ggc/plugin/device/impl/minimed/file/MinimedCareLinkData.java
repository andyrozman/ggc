...
public abstract class MinimedCareLinkData
{
    ...
    // Linked BG Meter ID, Temp Basal Amount (U/h),Temp Basal Type,Temp Basal
    // Duration (hh:mm:ss),Bolus Type[10],
    // Bolus Volume Selected (U),Bolus Volume Delivered (U),
    // Programmed Bolus Duration (hh:mm:ss),Prime Type,Prime Volume Delivered
    // (U),Suspend,Rewind,BWZ Estimate (U),
    // BWZ Target High BG (mmol/L),BWZ Target Low BG (mmol/L),BWZ Carb Ratio
    // (grams),BWZ Insulin Sensitivity (mmol/L),
    // BWZ Carb Input (grams),BWZ BG Input (mmol/L),BWZ Correction Estimate
    // (U),BWZ Food Estimate (U),
    // BWZ Active Insulin (U),Alarm,Sensor Calibration BG (mmol/L),Sensor
    // Glucose (mmol/L),ISIG Value,
    // Daily Insulin Total (U),Raw-Type,Raw-Values,Raw-ID,Raw-Upload ID,Raw-Seq
    // Num,Raw-Device Type

    private String[] description = { "Index", "Date", "Time", "Timestamp", "New Device Time", "BG Reading (mmol/L)",
                                    "Linked BG Meter ID", "Temp Basal Amount (U/h)", "Temp Basal Type",
                                    "Temp Basal Duration (hh:mm:ss)", "Bolus Type",
    // Bolus Volume Selected (U),Bolus Volume Delivered (U),
    // Programmed Bolus Duration (hh:mm:ss),Prime Type,Prime Volume Delivered
    // (U),Suspend,Rewind,BWZ Estimate (U),
    // BWZ Target High BG (mmol/L),BWZ Target Low BG (mmol/L),BWZ Carb Ratio
    ...
    // public Hashtable<Integer, String> values = new Hashtable<Integer,
    // String>();
    ...
    public boolean isIdentified()
    {
        ...
        this.raw_type.equals("BGReceived")
                ...
                this.raw_type.equals("ChangeTimeGH")
                || // unknown
                this.raw_type.equals("ChangeTime")
                || // unknown
                this.raw_type.equals("CalBGForGH")
                || // unknown
                this.raw_type.equals("CalBGForPH")
                || // unknown
                this.raw_type.equals("SelfTest")
                ||

                // sensor
                this.raw_type.equals("SensorSync")
                || // unknown
                ...
                || // status - unknown
                this.raw_type.equals("SensorTimestamp")
                || // unknown
                ...
                || // alarm for sensor
                this.raw_type.equals("GlucoseSensorData")
                || // data
                ...
                this.raw_type.equals("UnabsorbedInsulin")
                || // unabsorbed insulin

                this.raw_type.equals("ChangeCarbRatio")
                || // change carb ratio
                ...
                this.raw_type.equals("ChangeBGTargetRange")
                || // target range
                this.raw_type.equals("ChangeBGTargetRangePattern")
                ||

                this.raw_type.equals("ChangeInsulinSensitivity")
                ...
                || this.raw_type.equals("CurrentTotalYesterday") || this.raw_type.equals("CurrentBatteryStatus")
                || this.raw_type.equals("CurrentTotalRemaining") || this.raw_type.equals("CurrentErrorStatus")
                ...
                || this.raw_type.equals("CurrentTotalToday") || this.raw_type.equals("CurrentTempBasal")
                ...
                || this.raw_type.equals("CurrentSensorEnable") || this.raw_type.equals("CurrentSensorHighGlucoseLimit")
                ...
                this.raw_type.equals("CurrentParadigmLinkID") || this.raw_type.equals("CurrentBolusWizardSetupStatus")
                ...
                || this.raw_type.equals("CurrentSavedSettingsTime") || this.raw_type.equals("CurrentHistoryPageNumber")
                ||

                this.raw_type.equals("CurrentRemoteControlID") || this.raw_type.equals("CurrentPumpStatus")
                ...
                this.raw_type.equals("CurrentCarbRatioPattern") || this.raw_type.equals("CurrentCarbRatio") ||

                this.raw_type.equals("CurrentInsulinSensitivityPattern")
                || this.raw_type.equals("CurrentInsulinSensitivity") ||

                this.raw_type.equals("CurrentBasalProfile") || this.raw_type.equals("CurrentBasalProfilePattern")
         ...
         * this.raw_type.equals("SensorWeakSignal") || // warning - sensor weak
         * signal
    ...
    // System.out.println(count + ": [size=" + ld.length + ",id=" + ld[0] +
    // ",el33=" + ld[33] + "]");
    ...
    {
        return "MinimedCareLinkData [index=" + this.index + "date=" + this.date + ",time=" + this.time + ",raw_type="
                + this.raw_type + ",raw_values=" + this.raw_values + ",raw_device_type=" + this.raw_device_type + "]";
        // "\nraw_id=" + this.raw_id + ",raw_upload_id=" + this.raw_upload_id +
        // ",raw_seq_num=" + this.raw_seq_num;
    }
    ...
    public void createStaticData()
    {
         ...
         * this.data_unprocessed.put("ClearAlarm", "");
         * this.data_unprocessed.put("ClearAlarm", "");
         * // private static Hashtable<String,String> data_unprocessed = new
         * Hashtable<String,String>();
         * // private static Hashtable<String,String> data_cgms = new
         * Hashtable<String,String>();
         * // private static Hashtable<String,String> data_pump = new
         * Hashtable<String,String>();
         ...
         * this.raw_type.equals("JournalEntryPumpLowReservoir") ||
         * // report
         * this.raw_type.equals("ResultDailyTotal") || // report - result daily
         * total
         * this.data_unprocessed.put("UnabsorbedInsulin") || // unabsorbed
         * insulin
         ...
         * this.raw_type.equals("ChangeBGTargetRangePattern") ||
         * this.raw_type.equals("ChangeInsulinSensitivity") || // change insulin
         * sensitivity
         * this.raw_type.equals("ChangeInsulinSensitivityPattern") || //
         * // current
         * this.raw_type.equals("CurrentAlarmNotifyMode") ||
    ...
    protected String getDataNumber(String source, String f1, String f2)
    {
        ...
        s = ATDataAccessAbstract.replaceExpression(s, " ", "");
        s = s.replace(',', '.');
