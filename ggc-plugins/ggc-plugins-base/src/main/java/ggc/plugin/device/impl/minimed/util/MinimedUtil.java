 ...
 *
 *  Filename:     MinimedUtil
 *  Description:  Minimed Util
 *
 *  Author: Andy {andy@atech-software.com}
 */

public class MinimedUtil
{

    private static final Logger LOG = LoggerFactory.getLogger(MinimedUtil.class);
    ...
    {
        MinimedUtil.outputWriter = outputWriter;
    }
    ...
    {
        return MinimedUtil.connectionParameters;
    }


    public static void setClockMode(ClockModeType clockMode)
    {
        MinimedUtil.clockMode = clockMode;
    }
    ...
    {
        MinimedUtil.glucoseUnitType = glucoseUnitType;
    }
    ...
    {
        MinimedUtil.communicationInterface = communicationInterface;
    }
    ...
    {
        MinimedUtil.minimedDeviceReader = minimedDeviceReader;
    }


    public static boolean isDownloadCanceled()
    {
        return MinimedUtil.minimedDeviceReader.isDownloadCanceled();
    }
    ...
    {
        MinimedUtil.firmwareVersion = firmwareVersion;
    }
    ...
    {
        MinimedUtil.lowLevelDebug = lowLevelDebug;
    }


    public static void setIoDelay(int ioDelay)
    {
        MinimedUtil.ioDelay = ioDelay;
    }
