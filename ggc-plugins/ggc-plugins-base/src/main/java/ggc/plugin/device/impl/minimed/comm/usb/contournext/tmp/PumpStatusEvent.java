package ggc.plugin.device.impl.minimed.comm.usb.contournext.tmp;
...
public class PumpStatusEvent
{
    ...
    private Date eventDate; // The actual time of the event (assume the capture
                            // device eventDate/time is accurate)
    private Date pumpDate; // The eventDate/time on the pump at the time of the
                           // event
    ...
    private boolean recentBolusWizard; // Whether a bolus wizard has been run
                                       // recently
    private int bolusWizardBGL; // in mg/dL. 0 means no recent bolus wizard
                                // reading.
    ...
    {
        NONE, DOUBLE_UP, SINGLE_UP, FOURTY_FIVE_UP, FLAT, FOURTY_FIVE_DOWN, SINGLE_DOWN, DOUBLE_DOWN, NOT_COMPUTABLE, RATE_OUT_OF_RANGE, NOT_SET
    }
}
