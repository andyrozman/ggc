...
/**
 * Created by andy on 28/08/17.s∂
 */
public class AbbottUtil
{

    private static final Logger LOG = LoggerFactory.getLogger(AbbottUtil.class);
    ...
    {
        AbbottUtil.outputWriter = outputWriter;
    }
