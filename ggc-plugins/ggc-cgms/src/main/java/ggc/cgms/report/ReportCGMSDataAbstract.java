...
public abstract class ReportCGMSDataAbstract extends PrintAbstractIText
{

    protected DeviceValuesRange deviceValuesRange;
    protected DataAccessCGMS dataAccessCGMS = null;
     ...
     * @param dvr
     */
    public ReportCGMSDataAbstract(DeviceValuesRange dvr)
    {
        super(DataAccessCGMS.getInstance(), false);
