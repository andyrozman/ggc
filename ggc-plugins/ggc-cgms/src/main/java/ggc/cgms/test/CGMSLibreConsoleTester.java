...
import ggc.cgms.device.abbott.libre.LibreCGMSHandler;
...
public class CGMSLibreConsoleTester extends AbstractCGMSTest
{
     ...
     * @param portName
     */
    public CGMSLibreConsoleTester(String portName)
    {
    ...
    public void startLibre() throws Exception
    {
        LibreCGMSHandler handler = new LibreCGMSHandler();
        ...
        if (config)
        {
            handler.readConfiguration(CGMSDeviceDefinition.AbbottFreeStyleLibre, "1a61:3650",
                new ConsoleOutputWriter());
        }
        else
        {
            handler.readDeviceData(CGMSDeviceDefinition.AbbottFreeStyleLibre, "1a61:3650", new ConsoleOutputWriter());
        }
    }
    ...
    public static void main(String args[])
    {
        try
        {
            ...
            if (args.length == 0)
            {
                new CGMSLibreConsoleTester("");
            }
            else
            {
                new CGMSLibreConsoleTester(args[0]);
            }
