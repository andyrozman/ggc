...
public class ConnectValuesTableModel extends DeviceValuesTableModel
{

    private static final long serialVersionUID = 2881771615052748327L;

    private static final Logger LOG = LoggerFactory.getLogger(ConnectValuesTableModel.class);
     ...
     * @param source
     */
    public ConnectValuesTableModel(DeviceDataHandler ddh, String source)
    {
        super(ddh.getDataAccessInstance(), ddh, source);
    ...
    {
        System.out.println("AddEntry: " + mve);
    ...
    //
    // if (this.shouldBeDisplayedOld(mve.getStatus()))
    // {
    ...
    private void addEntryAndProcess(String key, CGMSValuesEntry mve)
    {
        ...
        else
        {
            ...
            if (this.shouldBeDisplayed(mve.getStatusType()))
            {
                ...
                System.out.println("Size: " + displayed_dl_data);
