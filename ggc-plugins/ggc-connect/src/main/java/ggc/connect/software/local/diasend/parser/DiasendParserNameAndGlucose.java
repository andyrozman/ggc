 ...
 */
public class DiasendParserNameAndGlucose extends DiasendParserAbstract
{

    private static final Logger LOG = LoggerFactory.getLogger(DiasendParserNameAndGlucose.class);
