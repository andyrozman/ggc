 ...
 *
 *  Filename:     ArkrayMeterHandler
 *  Description:  Arkray Meter Handler
 *
 *  Author: Andy {andy@atech-software.com}
 */

public class ArkrayMeterHandler extends MeterDeviceHandler
{
    ...
    {
        ArkrayMeterDataReader dataReader = new ArkrayMeterDataReader(definition, (String) connectionParameters,
                outputWriter);
        dataReader.readData();
    }
