...
import ggc.meter.device.abbott.neo.AbbottNeoMeterDataReader;
...
public class AbbottNeoMeterHandler extends MeterDeviceHandler implements UsbHidDeviceHandler
{

    public DeviceHandlerType getDeviceHandlerKey()
    {
        return DeviceHandlerType.AbbottMeterHandler;
    }
    ...
    {
        AbbottNeoMeterDataReader dataReader = new AbbottNeoMeterDataReader(this, definition, (String) connectionParameters,
                outputWriter);
        dataReader.readData();
    }
