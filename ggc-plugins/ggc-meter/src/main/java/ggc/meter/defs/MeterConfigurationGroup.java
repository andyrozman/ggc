...
public enum MeterConfigurationGroup implements DeviceConfigurationGroup
{
    ...
    static Map<Integer, MeterConfigurationGroup> codeMapping = new HashMap<Integer, MeterConfigurationGroup>();
    ...
    static
    {
        for (MeterConfigurationGroup pbt : values())
        {
    ...
    MeterConfigurationGroup(int code, String i18nKey)
    {
        this.code = code;
