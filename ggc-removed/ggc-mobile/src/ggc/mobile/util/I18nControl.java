...
/*
 * This is abstract class for controling I18N. You need to extend this class,
 * and set all variables. With setting of variables half of work is done. Next
 * half is way to create this class. You need to make constructor. Sample
...
public class I18nControl
{
    ...
    private void getSelectedLanguage()
    {
        ...
        try
        {
            ...
            FileInputStream in = new FileInputStream("../data/GGC_Mobile_Config.properties");
            props.load(in);
    ...
    /*
     * 
     * This method sets handle to I18NControl to null and deletes the instance.
     * <br><br>
     */
    ...
    /*
     * } { "English", "German", "Slovene", "Simp. Chinese" };
     */

    protected Locale lcls[] = null;

    /*
     * { Locale.ENGLISH, Locale.GERMAN, new Locale("SI"),
     ...
     * This is I18nControl constructor; Since classes use Singleton Pattern,
     * constructor is protected and can be accessed only with getInstance()
     * method. This constructor should be implemented by implementing
     * class<br><br>
     */
    /*
     * private I18nControlAbstract() { setLanguage("EN"); }
     */
     ...
     * object was created yet, it creates one.<br><br> This method should be
     * implemented by implementing class, if we want to use singelton<br><br>
     * 
     * @return Reference to OmniI18nControl object
     */
    /*
     * static public I18nControlAbstract getInstance() { if (m_i18n == null)
     * m_i18n = new I18nControlAbstract(); return m_i18n; }
     */

    // Method: deleteInstance
    /*
     * 
     * This method sets handle to OmniI18NControl to null and deletes the
     * instance. <br><br>
     */
    /*
     * public void deleteInstance() { m_i18n=null; }
     */
     ...
     * is defaulted. if none is found, application will exit.<br><br>
     * 
