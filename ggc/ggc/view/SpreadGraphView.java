...
import ggc.gui.SpreadGraphFrame;
...
public class SpreadGraphView extends AbstractGraphView
{
    ...
    public SpreadGraphView(GlucoValues gV)
    {
        this();
        this.gV = gV;
    ...
    protected void drawValues(Graphics2D g2D)
    {
        ...
        boolean drawBG = sGF.getDrawBG();
        boolean drawBU = sGF.getDrawBU();
        boolean drawIns1 = sGF.getDrawIns1();
        boolean drawIns2 = sGF.getDrawIns2();

        boolean connect = sGF.getConnectDays();
