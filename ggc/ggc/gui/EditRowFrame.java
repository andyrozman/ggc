...
public class EditRowFrame extends JFrame
{
    
    private I18nControl m_ic = I18nControl.getInstance();    
    
    static EditRowFrame singleton = null;
    ...
    public EditRowFrame(AbstractTableModel m, DailyValues ndV)
    {
        super("Add New Row");
        super.setTitle(m_ic.getMessage("EDIT_NEW_ROW"));
        dV = ndV;
        mod = m;
        init();
    }

    public EditRowFrame(AbstractTableModel m, DailyValues ndV, String nDate)
    {
        super("Add New Row");
        super.setTitle(m_ic.getMessage("EDIT_NEW_ROW"));
        sDate = nDate;
    ...
    public static EditRowFrame getInstance(AbstractTableModel m, DailyValues ndV)
    {
        if (singleton == null)
            singleton = new EditRowFrame(m, ndV);
        return singleton;
    }

    public static EditRowFrame getInstance(AbstractTableModel m, DailyValues ndV, String nDate)
    {
        if (singleton == null)
            singleton = new EditRowFrame(m, ndV, nDate);
        return singleton;
    }
