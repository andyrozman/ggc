...
//    static AddRowFrame singleton = null;
    ...
    public BolusHelper(DailyValues ndV, String nDate, JDialog dialog) 
    {
        super(dialog, "", true);
    ...
    public BolusHelper(DailyValues ndV, String nDate, JFrame frame) 
    {
        super(frame, "", true);
        m_parent = frame;
        initParameters(ndV,nDate);
    ...
    public BolusHelper(DailyValuesRow ndr, JDialog dialog) 
    {
        super(dialog, "", true);
        m_parent = dialog;
        initParameters(ndr);
    ...
    public BolusHelper(DailyValuesRow ndr, JFrame frame) 
    {
        super(frame, "", true);
        m_parent = frame;
        initParameters(ndr);
