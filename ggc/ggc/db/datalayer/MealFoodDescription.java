...
import ggc.db.hibernate.MealFoodDescriptionH;


public class MealFoodDescription extends MealFoodDescriptionH implements DatabaseObjectHibernate
{

    public boolean debug = false;


    public MealFoodDescription()
    {
        this.setId(0);
    ...
    public MealFoodDescription(MealFoodDescriptionH ch)
    {
	this.setId(ch.getId());
