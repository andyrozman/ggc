...
public class LInfoPanel extends JPanel
{
    private Vector vInfoPanels = new Vector();

    GGCLittle m_little = null;

    public DailyStatsControlsPanel control = null;
    public DailyStatsPanel dailyStats = null;


    public LInfoPanel(GGCLittle little)
    {
	m_little = little;
	...
	pane.add(new LGeneralInfoPanel());
	pane.add(control = new DailyStatsControlsPanel(little));

	//ggc.little.
	
	add(pane);
	//add(new LGeneralInfoPanel());
	add(dailyStats = new DailyStatsPanel(little));
