...
public class DailyRowDialogPen extends JDialog implements ActionListener, KeyListener, HelpCapable, FocusListener
{
    ...
    public DailyRowDialogPen(JFrame f)
    {
        super(f);
    ...
    public DailyRowDialogPen(DailyValues ndV, String nDate, JDialog dialog)
    {
        super(dialog, "", true);
    ...
    public DailyRowDialogPen(DailyValues ndV, String nDate, JFrame frame)
    {
        super(frame, "", true);
        m_parent = frame;
        initParameters(ndV, nDate);
    ...
    public DailyRowDialogPen(DailyValuesRow ndr, JDialog dialog)
    {
        super(dialog, "", true);
        m_parent = dialog;
        initParameters(ndr);
    ...
    public DailyRowDialogPen(DailyValuesRow ndr, JFrame frame)
    {
        super(frame, "", true);
        m_parent = frame;
        initParameters(ndr);
    ...
    {
        // if (add)
        setTitle(m_ic.getMessage("ADD_ROW") + " [Pen]");
    ...
    {
        setTitle(m_ic.getMessage("EDIT_ROW") + " [Pen]");
    ...
    public JFormattedTextField getTextField(int columns, int decimal_places, Object value, int x, int y, int width, int height, Container cont)
