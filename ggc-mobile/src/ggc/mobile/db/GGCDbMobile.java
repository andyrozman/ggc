...
//        new SchemaExport(this.getHibernateConfiguration().getConfiguration()).create(true, true);
    ...
    public void createConfiguration()
    {
        ...
        {
            System.out.println("Exception on creation. " + ex);
            ex.printStackTrace();
        }         
...
//        this.hib_config.getConfiguration();
    ...
    public boolean addDAO(DatabaseAccessObject doh)
    {
...
*/
    ...
    public boolean editDAO(DatabaseAccessObject doh)
    {
    ...
    public boolean getDAO(DatabaseAccessObject doh)
    {
    ...
    public boolean deleteDAO(DatabaseAccessObject doh)
    {
            ...
            try
            {
                ...
                if (doh.dbHasChildren(this.getConnection()))
                {
                ...
                doh.dbDelete(this.getConnection());
...
/*                
            ...
            <property name="meals_ids"  type="text" />
