...
public class AccuChekAvivaCombo extends AccuChekSmartPixMeter
{
     ...
     * @param cmp
     */
    public AccuChekAvivaCombo(AbstractDeviceCompany cmp)
    {
        super(cmp);
    }
     ...
     * @param writer
     */
    public AccuChekAvivaCombo(String drive_letter, OutputWriter writer)
    {
     ...
     * @param da
     */
    public AccuChekAvivaCombo(String comm_parameters, OutputWriter writer, DataAccessPlugInBase da)
    {
