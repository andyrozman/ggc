...
public class AccuChekActive extends AccuChekSmartPix
{
    ...
    {
        return AccuChekSmartPix.METER_ACCUCHEK_ACTIVE;
    }
    ...
    {
        return "INSTRUCTIONS_ACCUCHEK_ACTIVE";
    }
    ...
    {
        return "ggc.meter.device.accuchek.AccuChekActive";
    }
