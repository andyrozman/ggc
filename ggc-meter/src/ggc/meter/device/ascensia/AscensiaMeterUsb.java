...
public abstract class AscensiaMeterUsb extends AbstractUsbMeter
{
     ...
     * @param cmp
     */
    public AscensiaMeterUsb(AbstractDeviceCompany cmp)
    {
        super(cmp);
    }
     ...
     * @param writer
     */
    public AscensiaMeterUsb(String portName, OutputWriter writer)
    {
     ...
     * @param da
     */
    public AscensiaMeterUsb(String comm_parameters, OutputWriter writer, DataAccessPlugInBase da)
    {
    ...
    public void readDeviceDataFull() throws PlugInBaseException
    {
        ...
        try
        {
             ...
             * }
             * System.out.println("Input: " + foo.GetInputReportLength() +
             * " output: " +
             * foo.GetOutputReportLength() + " feature: " +
         ...
         * try
         * {
         * System.out.println("USB Reading --- Start");
         * //usb_dev_handle handle = this.getUsbDevice().getDeviceHandle();
         * byte[] enq = new byte[1];
         * enq[0] = 6;
         * this.usbBulkWrite(0, enq);
         * byte[] data = this.usbBulkRead(0, 255);
         * System.out.println("USB Reading --- End");
         * /*
         * this.device_running = true;
         * write(6); // ENQ
