 ...
 * 
 *  Filename:     OneTouchBasic
 *  Description:  Support for LifeScan OneTouch Basic Meter
 * 
...
public class OneTouchBasic extends OneTouchMeter
{
     ...
     * @param writer
     */
    public OneTouchBasic(String portName, OutputWriter writer)
    {
     ...
     * @param da 
     */
    public OneTouchBasic(String comm_parameters, OutputWriter writer, DataAccessPlugInBase da)
    {
     ...
     * @param cmp
     */
    public OneTouchBasic(AbstractDeviceCompany cmp)
    {
        super(cmp);
    }
