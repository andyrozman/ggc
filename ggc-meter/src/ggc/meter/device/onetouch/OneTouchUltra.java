 ...
 * 
 *  Filename:     OneTouchUltra
 *  Description:  Support for LifeScan OneTouch Ultra Meter
 * 
...
public class OneTouchUltra extends OneTouchMeter
{
     ...
     * @param da 
     */
    public OneTouchUltra(String comm_parameters, OutputWriter writer, DataAccessPlugInBase da)
    {
