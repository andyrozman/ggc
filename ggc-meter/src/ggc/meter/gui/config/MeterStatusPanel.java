...
public class MeterStatusPanel extends AbstractPreferencesPanel implements ItemListener
{
...
*/
    ...
    public MeterStatusPanel(ConfigurationDialog parent)
    {
        super(parent);
        this.parent = parent;
        initData();
