...
import ggc.meter.device.pseudo.EZManagerDBMeter;
import ggc.meter.manager.MeterImplementationStatus;

public class PseudoMeters extends AbstractMeterCompany
{

    
    public PseudoMeters()
    {
        this.addDevice(new EZManagerDBMeter());
    }
    ...
    {
        return MeterImplementationStatus.FUNCTIONALITY_READ_DATA_FULL;
    }
