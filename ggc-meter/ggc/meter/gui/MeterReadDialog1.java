 ...
 * 
 */
public class MeterReadDialog1 extends JDialog implements ActionListener
{
...
//x    private GlucoTable resTable;
     ...
     */
    public MeterReadDialog1(JFrame owner)
    {
        super(owner);
...
//        infoPanel.setBorder(new TitledBorder(""));
    ...
    public void initMeter()
    {
    	...
    	System.out.println("Commented initMeter()");
