 ...
 * Window>Preferences>Java>Templates.
 */
public class MeterPrepareDialog extends JDialog implements ActionListener
{
...
//x    private GlucoTableModel model = null;
//x    private GlucoTable resTable;

//x    private JButton startButton;
//x    private JButton saveButton;
     ...
     */
    public MeterPrepareDialog(JFrame owner)
    {
        super(owner);
        this.parentMy = owner;
...
*/
        ...
        // basic instructions
        label = new JLabel(m_ic.getMessage("BASIC_INSTRUCTIONS") + ":");
        label.setBounds(200, 20, 250, 25);
        label.setFont(m_da.getFont(DataAccess.FONT_NORMAL_BOLD));
        panel.add(label);

        label = new JLabel(m_ic.getMessage("BASIC_INSTRUCTIONS_DESC"));
        label.setBounds(200, 45, 250, 125);
        label.setFont(m_da.getFont(DataAccess.FONT_NORMAL));
        label.setVerticalAlignment(JLabel.TOP);
        panel.add(label);

        // device instructions
        label = new JLabel(m_ic.getMessage("DEVICE_INSTRUCTIONS") + ":");
        label.setBounds(200, 135, 300, 25);
        panel.add(label);

        ta_info = new JTextArea();
        JScrollPane sp3 = new JScrollPane(ta_info);
        sp3.setBounds(200, 160, 250, 54);
        panel.add(sp3);
...
/*        
    ...
    {
        /*MeterPrepareDialog mrd =*/ new MeterPrepareDialog();
    }
