...
public class MeterListDialog extends JDialog implements TreeSelectionListener, ActionListener
{
...
//    add(pop);
    ...
    {
	    tree.setModel(new MeterListModel(this.m_root));
    }
    
    
    public void createPanels()
    {
    	panels = new MeterListAbstractPanel[2];

        panels[0] = new MeterListMainPanel(this);
        panels[1] = new MeterListCompanyPanel(this);
...
//x        selectedPanel = num;
    ...
    public void valueChanged(TreeSelectionEvent e) 
    {
    	...
    	if (this.selected_last_path instanceof MeterListRoot)
    	{
    		makePanelVisible(MeterListDialog.PANEL_MAIN);
    	}
    	else if (this.selected_last_path instanceof String)
    	{
    	    makePanelVisible(MeterListDialog.PANEL_METER_COMPANY);
    	    this.panels[MeterListDialog.PANEL_METER_COMPANY].setData(this.selected_last_path);
    	}
